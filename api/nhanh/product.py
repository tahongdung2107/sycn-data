...
class ProductService:
    ...
    def create_table(self):
        ...
        product_columns = {
            ...
            "avg_cost": "NVARCHAR(50)",
            "import_price": "NVARCHAR(50)",
            "price": "NVARCHAR(50)",
            "old_price": "NVARCHAR(50)",
            "wholesale_price": "NVARCHAR(50)",
            "other_name": "NVARCHAR(MAX)",
            "inventory_status": "NVARCHAR(50)",
            "status": "NVARCHAR(50)",
            "show_hot": "NVARCHAR(50)",
            "show_new": "NVARCHAR(50)",
            "show_home": "NVARCHAR(50)",
            "show_home_order": "NVARCHAR(50)",
            "preview_link": "NVARCHAR(MAX)",
            "shipping_weight": "NVARCHAR(50)",
            "width": "NVARCHAR(50)",
            "length": "NVARCHAR(50)",
            "height": "NVARCHAR(50)",
            "vat": "NVARCHAR(50)",
            "warranty_address": "NVARCHAR(MAX)",
            "warranty_phone": "NVARCHAR(50)",
        ...
        for product_id, product in products_data.items():
            try:
                ...
                processed_product = {
                    ...
                    "brand_id": str(product.get("brandId", "")),
                    "brand_name": str(product.get("brandName", "")),
                    "type_id": str(product.get("typeId", "")),
                    "type_name": str(product.get("typeName", "")),
                    "avg_cost": str(product.get("avgCost", "0")),
                    "import_price": str(product.get("importPrice", "0")),
                    "price": str(product.get("price", "0")),
                    "old_price": str(product.get("oldPrice", "0")),
                    "wholesale_price": str(product.get("wholesalePrice", "0")),
                    "other_name": str(product.get("otherName", "")),
                    "inventory_status": str(product.get("inventoryStatus", "0")),
                    "status": str(product.get("status", "0")),
                    "show_hot": str(product.get("showHot", "0")),
                    "show_new": str(product.get("showNew", "0")),
                    "show_home": str(product.get("showHome", "0")),
                    "show_home_order": str(product.get("showHomeOrder", "0")),
                    "preview_link": str(product.get("previewLink", "")),
                    "shipping_weight": str(product.get("shippingWeight", "0")),
                    "width": str(product.get("width", "")),
                    "length": str(product.get("length", "")),
                    "height": str(product.get("height", "")),
                    "vat": str(product.get("vat", "")),
                    "warranty_address": str(product.get("warrantyAddress", "")),
                    "warranty_phone": str(product.get("warrantyPhone", "")),
                    "warranty": str(product.get("warranty", "")),
                    "country_name": str(product.get("countryName", "")),
