...
def fetch_sales_data():
    ...
    data = {
        ...
        "skip": 0,
        "output": "by-key",
        "select": ["name", "code", "pos", "phone_omicall", "email", "phone"]
    }
    ...
    all_data = []
    print(f"Tổng số sales cần lấy: {total}")
    ...
    for batch in range(total_batches):
        ...
        if isinstance(result, dict) and 'data' in result and isinstance(result['data'], list):
            ...
            if batch == 0 and batch_data:
                ...
                create_table_from_object(result_for_table, "crm_data_sales")
        else:
    ...
    if all_data:
        ...
        insert_or_update_customer(final_result, table_name="crm_data_sales")
